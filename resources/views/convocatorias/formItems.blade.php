...
<div class="page-header header-filter" data-parallax="true" style="background-image: url( {{ asset('../img/imagen4.jpg') }} );">     
</div>
...
<br>
    ...
    <div class="form-group col-md-6">
          ...
          <input type="text" name="NotaPorItem" class="form-control" id="NotaPorItem" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$">
          <div class="invalid-feedback">
